...
export const defaultSiteSettings: SiteSettings = {
  ...
  featureImage: "/products/wf-c879r.webp",
...
export const defaultHeroSlides: HeroSlide[] = [
  {
    ...
    imageUrl: "/products/wf-c879r.webp",
  ...
  },
  {
    ...
    subtitle: "حلول متكاملة للطباعة ومستلزماتها",
    description: "طابعات احترافية، أوراق متخصصة، وأحبار موثوقة لمختلف احتياجات العمل والطباعة.",
...
export const starterProducts: StoredProduct[] = [
  { id: 1, name: "Epson WorkForce Pro EM-C800RDWF", family: "Epson WorkForce Pro", image: "/products/em-c800.jpg", category: "printers", type: "متعددة الوظائف", size: "A4", badge: "الأكثر طلبًا", description: "طابعة أعمال ملونة ذكية تجمع الطباعة والنسخ والمسح والفاكس في جهاز واحد.", features: ["طباعة ملونة احترافية", "شاشة لمس سهلة", "طباعة ونسخ ومسح", "مناسبة لفرق العمل"], sortOrder: 1 },
  ...
  { id: 3, name: "EPSON WorkForce Pro WF-C5390", family: "WorkForce Pro", image: "/products/wf-c5390.webp", category: "printers", type: "طباعة فقط", size: "A4", badge: "للأعمال", description: "طابعة مكتبية ملونة سريعة ومدمجة للشركات التي تحتاج إنجازًا يوميًا ثابتًا.", features: ["ألوان واضحة", "تصميم مكتبي مدمج", "تشغيل سهل", "جاهزة للشبكات"], sortOrder: 3 },
  ...
  { id: 5, name: "EPSON WorkForce Pro WF-C879R", family: "WorkForce Pro RIPS", image: "/products/wf-c879r.webp", category: "printers", type: "متعددة الوظائف", size: "A3", badge: "فئة احترافية", description: "طابعة متعددة الوظائف للشركات تجمع المرونة في التعامل مع الورق وكفاءة التشغيل.", features: ["طباعة A3 ملونة", "لوحة تحكم كبيرة", "سعة ورق قابلة للتوسعة", "مناسبة للأقسام"], sortOrder: 5 },
  ...
  { id: 7, name: "Epson WorkForce Pro EM-C800RDWF + Tray", family: "Epson WorkForce Pro", image: "/products/em-c800-tray.jpg", category: "printers", type: "متعددة الوظائف", size: "A4", badge: "سعة إضافية", description: "نسخة مجهزة بدرج إضافي لتوفير سعة ورق أكبر واستمرارية أفضل في بيئات العمل.", features: ["درج ورق إضافي", "مهام مكتبية متكاملة", "طباعة ملونة", "إنتاجية مستمرة"], sortOrder: 7 },
].map((product) => ({
  ...product,
